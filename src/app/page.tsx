      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          <p className={`antialiased text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>A</strong>dt <strong>D</strong>omain <strong>T</strong>ool
          </p>
          <p className={`antialiased text-lg text-gray-700 md:text-2xl md:leading-normal`}>
            Herramienta de administración del dominio formateya.es
          </p>
          <Link
            href="/login"
